This repository contains Guix attestations for releases of Bitweb Core.
...
See https://github.com/bitweb-project/bitweb/blob/master/doc/release-process.md#building on how to build the release with Guix and create an attestation.
